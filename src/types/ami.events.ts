...
export interface AMIQueueCallerLeaveEvent {
    Event: AMIEventTypes.QueueCallerLeave // The type of event, e.g., 'QueueCallerLeave'
    Privilege: 'agent,all' // Privilege level required to receive the event
    Channel: string // The channel associated with the event
    ChannelState: AMIChannelState // Numeric code representing the current state of the channel
    ChannelStateDesc: AMIChannelStateDescription // Description of the current state of the channel
...
export interface AMIQueueCallerAbandonEvent {
    Event: AMIEventTypes.QueueCallerAbandon // The type of event, e.g., 'QueueCallerAbandon'
    Privilege: 'agent,all' // Privilege level required to receive the event
    Channel: string // The channel associated with the event
    ChannelState: AMIChannelState // Numeric code representing the current state of the channel
    ChannelStateDesc: AMIChannelStateDescription // Description of the current state of the channel
    ...
    Uniqueid: string // Unique identifier for the call, used for tracking and logging
    Queue: string // The name or identifier of the queue involved in the event
    Position: string // The position of the caller in the queue at the time of abandoning
    OriginalPosition: string // The original position of the caller when they joined the queue
    HoldTime: string // The time, in seconds, the caller spent on hold before abandoning the queue
}
...
export interface AMIDTMFBeginEvent {
    Event: AMIEventTypes.DTMFBegin // The type of event, e.g., 'DTMFBegin'
    Privilege: 'dtmf,all' // Privilege level required to receive the event
    Channel: string // The channel associated with the event
    ChannelState: AMIChannelState // Numeric code representing the current state of the channel
    ChannelStateDesc: AMIChannelStateDescription // Description of the current state of the channel
    CallerIDNum: string // Caller ID number of the calling party
    ...
    Reg_callername: string // Registered caller name, if applicable
    Uniqueid: string // Unique identifier for the call, used for tracking and logging
    Digit: string // The DTMF digit that was pressed (e.g., '0'-'9', '*', '#', 'A'-'E')
    Direction: 'Received' | 'Sent' // Direction of the DTMF signal ('Received' or 'Sent')
}

export interface AMIDTMFEndEvent {
    Event: AMIEventTypes.DTMFEnd // The type of event, e.g., 'DTMFEnd'
    Privilege: 'dtmf,all' // Privilege level required to receive the event
    Channel: string // The channel associated with the event
    ChannelState: AMIChannelState // Numeric code representing the current state of the channel
    ChannelStateDesc: AMIChannelStateDescription // Description of the current state of the channel
    ...
    Uniqueid: string // Unique identifier for the call, used for tracking and logging
    Digit: string // The DTMF digit that was pressed (e.g., '0'-'9', '*', '#', 'A'-'E')
    DurationMs: string // Duration (in milliseconds) DTMF was sent/received
    Direction: 'Received' | 'Sent' // Direction of the DTMF signal ('Received' or 'Sent')
}
